...
kinp = kop.input("kafka-in", flow, brokers=brokers, topics=["raw_ais_reports"],starting_offset=OFFSET_END,batch_size=4)
...
collected_stream = op.collect(
    "collect", keyed_stream, timeout=timedelta(seconds=10), max_size=120
)
