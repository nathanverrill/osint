...
tracked = op.map("Calculate Tracks", binned, AISBytewaxOperations.calculate_tracks)
features = op.map("Calculate Features for Analytics", tracked, AISBytewaxOperations.calculate_features)
